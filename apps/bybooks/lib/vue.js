              ...
              if (
                ...
                (shouldCondense &&
                  ((prev.type === 3 /* NodeTypes.COMMENT */ && next.type === 3) /* NodeTypes.COMMENT */ ||
                    (prev.type === 3 /* NodeTypes.COMMENT */ && next.type === 1) /* NodeTypes.ELEMENT */ ||
                    (prev.type === 1 /* NodeTypes.ELEMENT */ && next.type === 3) /* NodeTypes.COMMENT */ ||
    ...
    getNamespace(tag, parent) {
      ...
      if (parent && ns === 2 /* DOMNamespaces.MATH_ML */) {
        if (parent.tag === 'annotation-xml') {
          ...
          if (
            parent.props.some(
              (a) => a.type === 6 /* NodeTypes.ATTRIBUTE */ && a.name === 'encoding' && a.value != null && (a.value.content === 'text/html' || a.value.content === 'application/xhtml+xml')
            )
          ) {
